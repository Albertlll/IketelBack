...
- Используется для хранения состояния комнат и таблицы лидеров.
- Настройки: `REDIS_URL`, `REDIS_ROOM_TTL_SECONDS`.
- Ключи комнаты живут с TTL, удаляются при завершении игры или выходе хоста.
